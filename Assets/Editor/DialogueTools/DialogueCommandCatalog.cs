...
public static class DialogueCommandCatalog {
    private static readonly List<DialogueCommandSpec> Specs = new List<DialogueCommandSpec> {
        ...
        new DialogueCommandSpec("combatDirect", "Flow",
            new DialogueArgumentSpec("combat id", DialogueArgumentType.ResourceName)),
        new DialogueCommandSpec("dialogue", "Flow",
            new DialogueArgumentSpec("dialogue id", DialogueArgumentType.ResourceName)),
        new DialogueCommandSpec("gearStop", "Flow",
            new DialogueArgumentSpec("gear stop id", DialogueArgumentType.ResourceName)),
        new DialogueCommandSpec("title", "Metadata",
            new DialogueArgumentSpec("title", DialogueArgumentType.Text, consumeRemaining: true)),
